...
Meteor.methods({
    ...
    createStudyImportStatus: function() {
        ...
        return JF.studylist.collections.StudyImportStatus.insert(studyImportStatus);
    },
    /**
    ...
    removeStudyImportStatus: function(id) {
        JF.studylist.collections.StudyImportStatus.remove(id);
    }
});
        ...
        try {
            ...
            fiber(function() {
                try {
                    ...
                    if (err) {
                        JF.studylist.collections.StudyImportStatus.update(
