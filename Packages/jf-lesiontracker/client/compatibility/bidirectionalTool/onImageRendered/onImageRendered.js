    ...
    for (let i = 0; i < toolData.data.length; i++) {
        ...
        if (data.visible) {
            ...
            if (data.invalidated === false) {
                ...
                const ellipse = {
                    left: Math.round(Math.min(Math.min(start.x, end.x), Math.min(perpendicularStart.x, perpendicularEnd.x))),
                    top: Math.round(Math.min(Math.min(start.y, end.y), Math.min(perpendicularStart.y, perpendicularEnd.y))),
                    right: Math.round(Math.max(Math.max(start.x, end.x), Math.max(perpendicularStart.x, perpendicularEnd.x))),
                    bottom: Math.round(Math.max(Math.max(start.y, end.y), Math.max(perpendicularStart.y, perpendicularEnd.y)))
                };
