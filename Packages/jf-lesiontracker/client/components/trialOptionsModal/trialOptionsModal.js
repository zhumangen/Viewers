...
Meteor.startup(() => {
    ...
    JF.lesiontracker.TrialCriteriaTypes = TrialCriteriaTypes;
});

Template.trialOptionsModal.onCreated(() => {
    const instance = Template.instance();
    const { TrialCriteriaTypes } = JF.lesiontracker;
...
Template.trialOptionsModal.helpers({
    getDescriptionTemplate(_id) {
        return JF.lesiontracker.TrialCriteriaTypes.findOne(_id).descriptionTemplate;
    }
});
