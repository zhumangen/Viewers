...
Template.layoutChooser.onRendered(() => {
    ...
    instance.refreshHighlights = () => {
        ...
        const info = JF.viewerbase.layoutManager.layoutProps;
...
Template.layoutChooser.events({
    ...
    'click .layoutChooser table td'(event, instance) {
        ...
        JF.viewerbase.layoutManager.layoutTemplateName = 'gridLayout';
        JF.viewerbase.layoutManager.layoutProps = layoutProps;
        JF.viewerbase.layoutManager.updateViewports();
